...
for subj = subjects_list
    ...
    meanSineBetas_hdr.fname = sprintf('%s\\PolarRetino_subj%d_meanSineBetas.img', RETINO_folder, subj);
    ...
    meanCosineBetas_hdr.fname = sprintf('%s\\PolarRetino_subj%d_meanCosineBetas.img', RETINO_folder, subj);
